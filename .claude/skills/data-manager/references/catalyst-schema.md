...
| `category` | enum | yes | Earnings / Corporate / Industry / Macro |
| `impact` | enum | yes | H / M / L |
| `pre_announce_risk` | boolean | yes | True if ticker has >=2 prior pre-announces in last 8 quarters |
