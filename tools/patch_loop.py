    ...
    *,
    ...
    return {
        ...
        "quality_gate": {
            ...
            "patchable_blocking_items": delivery_gate.get("patchable_blocking_items", []),
            "terminal_blocking_items": delivery_gate.get("terminal_blocking_items", []),
            "blocker_actions": delivery_gate.get("blocker_actions", {}),
